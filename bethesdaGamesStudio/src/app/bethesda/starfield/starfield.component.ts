...
export class StarfieldComponent implements OnInit {
  ...
  showThreeData = [
    {
      ...
      buy: 'https://www.instant-gaming.com/fr/2675-acheter-steam-starfield-pc-jeu-steam/',
    },
  ];
  ...
  ngOnInit(): void {
    this.routes.params.subscribe((params) => {
      ...
      this.showThreeDetails = this.showThreeData.find(
        (game) => game.id === this.showThreeId
      );
    });
  }
}
